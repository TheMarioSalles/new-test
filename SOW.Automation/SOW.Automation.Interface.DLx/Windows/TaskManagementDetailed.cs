...
{
	public class TaskManagementDetailed : WindowBase
	{
		public TaskManagementDetailed(WebService webService, DesktopService desktopService, OCRService ocrService)
		...
		public void InitializeWindow()
		{
			if (!this.ChecarJanela(@"\OCR\TaskManagementTitle.png"))
				...
				ClicarBotaoFind();
				if (!this.ChecarJanela(@"\OCR\TaskManagementTableMS.png"))
					this.FecharJanela();
				else {
					ClicarTabelaListagemAgendamentos();
					SelecionarTodosItensTabelaListagemAgendamentos();
					ClicarBotaoLocate();
					PreencherCampoFiltro("Shipment Allocation Operations");
					ClicarBotaoFiltroGo();
