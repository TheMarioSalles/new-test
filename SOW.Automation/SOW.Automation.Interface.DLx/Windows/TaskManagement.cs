...
{
	public class TaskManagement : WindowBase
	{
		public TaskManagement(WebService webService, DesktopService desktopService, OCRService ocrService)
		...
		{
			this.SegurarTecla(SOW.Automation.Common.KeyboardEnum.ALT);
			this.PressionarTecla(SOW.Automation.Common.KeyboardEnum.TAB);
			this.LiberarTecla(SOW.Automation.Common.KeyboardEnum.ALT);
			this.SegurarTecla(SOW.Automation.Common.KeyboardEnum.ALT);
			this.PressionarTecla(SOW.Automation.Common.KeyboardEnum.TAB);
			this.LiberarTecla(SOW.Automation.Common.KeyboardEnum.ALT);
		...
		{
			if (!this.ChecarJanela(@"\OCR\TaskManagementTitle.png"))
				this.FecharJanela();
			else {
				ClicarBotaoFind();
				if (!this.ChecarJanela(@"\OCR\TaskManagementTableStatusMS.png"))
					this.FecharJanela();
				else {
